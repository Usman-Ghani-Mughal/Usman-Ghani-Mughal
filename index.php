               ...
               <div class="col-lg-9 my-order-switch-1 ">
                  <section id="home" class="shadow bg-light radius-2 padding-dy text-center " >
                     <div class="row v-height-50 v-centred">
                        <div class="col-md-12">
                           <h1 class="font-weight-600 mb-0">Usman <mark>Ghani</mark> Mughal
                           </h1>
                           <div class="text-rotation">
                              <div class="item">
                                 <h6 class="h5 text-muted mt-1 mb-0 "> <span class=" text-rotating">Data Enthusiast, Software Engineer</span></h6>
                              </div>
                           </div>
                           <ul class="list-inline  mb-0 mt-4">
                              ...
                              <li class="list-inline-item mr-1 outer radius-2 mb-2 mb-lg-0">
                                 <a class="inner btn btn-round btn-icon" href="https://www.linkedin.com/in/usman-ghani-a50488142/" >
                                 <span class="fab fa-linkedin btn-icon-inner"></span>
                                 </a>
                              </li>
                              <li class="list-inline-item mx-0 outer radius-2 mb-2 mb-lg-0">
                                 <a class="inner btn btn-round btn-icon" href="https://github.com/Usman-Ghani-Mughal" >
                                 <span class="fab fa-github btn-icon-inner"></span>
                                 </a>
                              </li>
                              <li class="list-inline-item mr-1 outer radius-2 mb-2 mb-lg-0">
                                 <a class="inner btn btn-round btn-icon" href="https://stackoverflow.com/users/10096169/usman-ghani-mughal">
                                 <span class="fab fa-stack-overflow btn-icon-inner"></span>
                                 </a>
                              </li>
                              <li class="list-inline-item mx-0 outer radius-2 mb-2 mb-lg-0">
                                 <a class="inner btn btn-round btn-icon" href="https://www.youtube.com/channel/UC_InY1Qb2_wcp1jVO1-tNgg" >
                           ...
                           <a class="float-left" href="assets/docs/Usman_Ghani_Mughal.pdf">
                              <div class="media  align-items-center">
                                 ...
                                 <div class="media-body">
                                    <span class="text-muted font-size-13 font-weight-600 text-uppercase">Download my Resume</span>
                                 </div>
                              </div>
                           </a>
                        </div>
                                    ...
                                    <div class="ui-icon ui-icon-md inner ">
                                       <div class="ui-icon-inner">
                                          <svg version="1.1" class="max-width-1-3 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 518 518" enable-background="new 0 0 518 518;" xml:space="preserve">
                                             <g>
                                                <g>
                                                   <rect x="169.4" y="438.2" class="st0" width="179.2" height="25.6"></rect>
                                                </g>
                                             </g>
                                             <g>
                                                <g>
                                                   <rect x="169.4" y="387" class="st0" width="179.2" height="25.6"></rect>
                                                </g>
                                             </g>
                                             <g>
                                                <g>
                                                   <rect x="169.4" y="335.8" class="st0" width="179.2" height="25.6"></rect>
                                                </g>
                                             </g>
                                             <g>
                                                <g>
                  ...
                  <section id="about" class="shadow bg-light radius-2 padding-dy">
                     <div class="row mb-5">
                        <div class="col">
                     ...
                     <div class="row mb-2">
                        <div class="col-lg-12">
                           <h1 class="font-weight-600 mb-0">Usman <mark>Ghani</mark>Mughal</h1>
                           <h6 class="h5 text-muted">Data Enthusiast & Software Engineer</h6>
                        </div>
                     </div>
                     <div class="row mb-2">
                        <div class="col-md-6">
                           <p style="text-align:justify">
                              I'm an enthusiastic and diligent software technology
                              professional. Having worked on a variety of projects around various domains equips me with the ability
                              to adapt, enhance
                           </p>
                        </div>
                        <div class="col-md-6">
                           <p style="text-align:justify">
                              and optimize towards quality solution delivery.
                              I'm an equally exceptional performer under 
                              pressure with core focus at adhering timelines. 
                           </p>
                        </div>
                     </div>
                     <div class="row">
                           ...
                           <div class="text-center  p-2 radius-1 shadow-inner ">
                              <div class="shadow radius-1">
                                 <ul class="text-center info-list font-size-14 p-2 list-inline  mb-0">
                                    <li><span class="inf">Name </span>  <span class="value">Usman Ghani Mughal</span></li>
                                    <li><span class="inf">Birth</span>  <span class="value"> October 27, 1996 </span></li>
                                    <li><span class="inf">City</span>  <span class="value">Islamabad</span></li>
                                 </ul>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="text-center  p-2 radius-1 shadow-inner ">
                              <div class="shadow radius-1">
                                 <ul class=" text-center info-list p-2 font-size-14 list-inline mb-0">
                                    <li><span class="inf">Email</span>  <span class="value"> <small>osmanghanimughal@gmail.com</small> </span></li>
                                    <li><span class="inf">Phone</span>  <span class="value"> + 92 314 5270 917  </span></li>
                                    <li><span class="inf">Country</span>  <span class="value">Pakistan</span></li>
                                 </ul>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="row vc skill des mb-5">
                        <div class="col-md-11">
                           <ul class="skills-list list-inline mb-0">
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">Data Pipelines</h6>
                                 <div class="progress mb-3">
                                    <div class="percentage">
                                       90%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">Data Warehouses | Data lakes</h6>
                                 <div class="progress mb-3">
                                    <div class="percentage">
                                       85%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">(ETL | ELT) Processes</h6>
                                 <div class="progress">
                                    <div class="percentage">
                                       92%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">Data Modelling (Realational | NoSQL)</h6>
                                 <div class="progress">
                                    <div class="percentage">
                                       83%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">
                                    Data MANIPULATION (Numpy | Pandas | Matplotlib) </h6>
                                 <div class="progress">
                                    <div class="percentage">
                                       92%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">
                                    Machine Learning (Mlxtend | Scikit learn)</h6>
                                 <div class="progress">
                                    <div class="percentage">
                                       75%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">REST API</h6>
                                 <div class="progress">
                                    <div class="percentage">
                                       95%
                                    </div>
                     ...
                     <div class="row vc skill dev mb-5">
                        <div class="col-md-11">
                           <ul class="skills-list list-inline mb-0">
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">NODEJS</h6>
                                 <div class="progress mb-3">
                                    <div class="percentage">
                                       90%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">REACTJS</h6>
                                 <div class="progress mb-3">
                                    <div class="percentage">
                                       85%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">Angular</h6>
                                 <div class="progress mb-3">
                                    <div class="percentage">
                                       70%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">JQuery | Ajax</h6>
                                 <div class="progress mb-3">
                                    <div class="percentage">
                                       85%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">Design Patterns</h6>
                                 <div class="progress">
                                    <div class="percentage">
                                       80%
                                    </div>
                     ...
                     <div class="row vc skill prs">
                        <div class="col-md-11">
                           <ul class="skills-list list-inline mb-0">
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">Python</h6>
                                 <div class="progress mb-3">
                                    <div class="percentage">
                                       90%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">PHP</h6>
                                 <div class="progress">
                                    <div class="percentage">
                                       70%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">Java</h6>
                                 <div class="progress">
                                    <div class="percentage">
                                       80%
                                    </div>
                              ...
                              <li>
                                 <h6 class="font-weight-600 font-size-14 text-uppercase">C++</h6>
                                 <div class="progress">
                                    <div class="percentage">
                                       80%
                                    </div>
                        ...
                        <div class="col-md-12">
                           <div class="timeline">
                              ...
                              <div class=" pt-7">
                                 <div class="timeline-content">
                                    <div class="mb-1">
                                       <h6 class="font-weight-600 font-size-15 mb-1">BS Computer Science – COMSATS University Islamabad</h6>
                                       <div class="font-size-13 text-dark mb-1"><i class="fa fa-calendar mr-2 text-muted"></i>Feh 2017 - Jan 2021</div>
                                    </div>
                                    <p class=" mb-0">
                                       I took admission in CS with my own passion and through out the degree my focus was more towards
                                       the technical subjects for example PF, OOP, Data Structures, Data Bases, OS, CC etc. Selected 
                                       Data Science as my majors in Which I have studied Data Analysis, Intro to Data Science, Data Warehousing
                                       and Data Mining and Computational Intelligence, Completed my BS with 3.14 CGPA
                                          <strong>
                                             <a 
                                                 href="https://drive.google.com/file/d/17nDi3BkeR2Zfz5ju8GQ8r-qW8Dt7Sio_/view?usp=sharing">
                                                 BSCS TRANSCRIPT
                                             </a>
                  ...
                  <section id="portfolio" class="shadow bg-light radius-2 padding-dy work">
                     ...
                     <div class="row text-center">
                        <div class="col">
                           <ul class="filter mb-0 pl-0">
                              ...
                              <li class=" radius-2 mb-3 mb-md-0"> <a data-filter="data_engineering" href="#" class="inner radius-2">Data Engineering</a></li>
                              <li class=" radius-2 mb-3 mb-md-0"><a data-filter="data_science" href="#" class="inner radius-2">Data Science</a></li>
                              <li class=" radius-2 mb-3 mb-md-0"><a data-filter="software_development" href="#" class="inner radius-2">Software Development</a></li>
                           </ul>
                        </div>
                     </div>
                     <div class="row">
                     ...
                     <div class="row ">
                        ...
                        <div class="col-lg-4 mb-5 mb-lg-0">
                           <div class="item data_science software_development">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="news_recommender.html">
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/news_rec.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5 mb-lg-0">
                           <div class="item data_science">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="news_calssification.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/news_class.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5">
                           <div class="item data_science software_development">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-vbtype="video" data-overlay="rgba(52,58,64,.6)" href="algorithmic_tool.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/algo.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5 mb-lg-0">
                           <div class="item data_science">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="heart_disease_prediction.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/heart.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5">
                           <div class="item data_engineering">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="zameen_scraper.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/zameen.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4   mb-5">
                           <div class="item data_engineering">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="data_pipelines.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/DataPipeLines.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4   mb-5">
                           <div class="item software_development">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="assabur.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/assabur.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4  mb-5">
                           <div class="item data_science">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="tsp_lstm.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/lstm.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4   mb-5">
                           <div class="item software_development">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="network_traffic_analyser.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/network.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5">
                           <div class="item software_development">
                              <a class="radius-1 shadow-inner  hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="pakistan_local_emarket.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/pakistan-local-em.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5">
                           <div class="item data_engineering">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="data_modeling.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/datamodeling_p.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4   mb-5">
                           <div class="item data_engineering">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="data_lakes.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/datalake.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4   mb-5">
                           <div class="item data_engineering">
                              <a class="radius-1 shadow-inner hover-effect d-block" data-overlay="rgba(52,58,64,.6)" href="data_extraction_from_pdf.html">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/projects/data_extraction.png">
                                    </div>
                                 </div>
                              </a>
                           </div>
                  ...
                  <section id="blog" class="shadow bg-light radius-2 padding-dy ">
                     <div class="row mb-5">
                        <div class="col">
                           <h6 class="font-weight-700  mb-0 text-uppercase mb-2">Courses</h6>
                           <hr class="divider divider-left divider-lg float-left">
                        </div>
                     </div>
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="mb-4 item">
                              <a class="radius-1 shadow-inner d-block " href="assets/docs/usman_data_engineering_nano_degree.pdf">
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class="img-fluid radius-1" src="assets/img/blog/de_nano_d.png" alt="">
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div>
                              <h1 class="h5 font-weight-500 d-inline-block"><a href="assets/docs/usman_data_engineering_nano_degree.pdf">Data Engineering (Nanodegree - udacity)</a></h1>
                              <span class="d-inline-block shadow-inner text-secondary radius-1 font-size-13 mb-3 mb-lg-0  px-3">1 Jan 2022</span>
                           </div>
                           ...
                           <p>
                               ...
                               <ul>
                                  ...
                                  <li>Data Modeling with Apache Cassandra</li>
                               </ul>
                               <strong>Cloud Data Warehouses</strong>
                               <ul>
                                  <li>Amazon Redshift</li>
                               </ul>
                               <strong>Data Lakes with Spark</strong>
                               <ul>
                                  <li>Data Lakes</li>
                               </ul>
                               <strong>Data Pipelines with Airflow</strong>
                               <ul>
                        ...
                        <div class="col-md-12">
                           <div class="mb-4 item">
                              <a class="radius-1 shadow-inner d-block " href="https://www.hackerrank.com/certificates/19f1ba527105">
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class="img-fluid radius-1" src="assets/img/blog/usman_sql_intermediate.png" alt="">
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div>
                              <h1 class="h5 font-weight-500 d-inline-block"><a href="https://www.hackerrank.com/certificates/19f1ba527105"> HackerRank SQL (intermediate) </a></h1>
                              <span class="d-inline-block shadow-inner text-secondary radius-1 font-size-13 mb-3 mb-lg-0  px-3">22 Mar 2022</span>
                           </div>
                        ...
                        <div class="col-md-12">
                           <div class="mb-4 item">
                              <a class="radius-1 shadow-inner d-block " href="https://www.hackerrank.com/usmangm087">
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class="img-fluid radius-1" src="assets/img/blog/problem_solving3.png" alt="">
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div>
                              <h1 class="h5 font-weight-500 d-inline-block"><a href="https://www.hackerrank.com/usmangm087"> HackerRank Problem Solving 3 Stars </a></h1>
                              <span class="d-inline-block shadow-inner text-secondary radius-1 font-size-13 mb-3 mb-lg-0  px-3">22 Mar 2022</span>
                           </div>
                        ...
                        <div class="col-md-12">
                           <div class="mb-4 item">
                              <a class="radius-1 shadow-inner d-block " href="https://www.linkedin.com/in/usman-ghani-a50488142/">
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class="img-fluid radius-1" src="assets/img/blog/linkedin_assesments.png" alt="">
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div>
                              <h1 class="h5 font-weight-500 d-inline-block"><a href="https://www.linkedin.com/in/usman-ghani-a50488142/"> LinkedIn Assessments </a></h1>
                              <span class="d-inline-block shadow-inner text-secondary radius-1 font-size-13 mb-3 mb-lg-0  px-3"></span>
                           </div>
                  ...
                  <section id="contact" class="shadow bg-light radius-2 padding-dy">
                     <!-- <div class="row mb-5">
                        <div class="col">
                        ...
                        <div class="col-lg-12">
                           <div class="item">
                              ...
                              <a class="radius-1 shadow-inner d-block " href="https://goo.gl/maps/VzdvTYgNeqtEtVJT7">
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class="img-fluid radius-1" src="assets/img/map-light.jpg" alt="">
                                    </div>
                                 </div>
                              </a>
                           </div>
                     ...
                     <div class="row info-before position-relative">
                        <div class="col-md-12 mb-5">
                           <div class="w-75 m-auto ">
                              ...
                              <h2 class="h5 font-size-18 text-center font-weight-600 mt-4">Islamabad<br>Pakistan
                              </h2>
                           </div>
                        </div>
                        <div class="col-md-4 mb-3 mb-lg-0">
                           <div class="  text-center">
                              ...
                              <p class="mb-0 mt-3 font-size-14 shadow-inner radius-2 px-3 py-1"> <small style="font-size:smaller;" >osmanghanimughal@gmail.com</small> </p>
                           </div>
                        </div>
                        <div class="col-md-4 mb-3 mb-lg-0">
                           <div class="  text-center">
                              ...
                              <p class="mb-0 mt-3 font-size-14 shadow-inner radius-2 px-3 py-1">Phone : +92314-5270917 </p>
                           </div>
                        </div>
                        <div class="col-md-4 mb-3 mb-lg-0">
                           <div class="  text-center">
                              ...
                              <p class="mb-0 mt-3 font-size-14 shadow-inner radius-2 px-3 py-1">Site : www.yoursite.com</p>
                           </div>
                        </div>
                     </div>
                     <div class="row mb-5 mt-6">
               ...
               <div class="col-lg-3 pl-lg-0  my-order-switch-2 mb-lg-0 mb-5">
                  <div class="sticky-lg-top">
                     <header class="shadow bg-light radius-2 px-4 py-6 text-center ">
                        ...
                        <div class="mt-4 mb-5">
                           <h3 class="font-weight-600 mb-0">Usman Ghani
                           </h3>
                           <h6 class="text-muted">Data Enthusiast & Software Engineer</h6>
                        </div>
                           ...
                           <ul class="pl-0">
                              ...
                              <li class="outer radius-2 mb-3">
                                 <a class="inner radius-2" href="#about" >
                                    <div class="media  align-items-center ">
                                       <div class="media-body text-left">
                                          <span class="font-weight-600 font-size-13 text-uppercase  text-secondary-2">About</span>
                                       </div>
                                       <svg version="1.1" class="max-width-1 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                              ...
                              <li class="outer radius-2 mb-3">
                                 <a class="inner radius-2" href="#portfolio" >
                                    <div class="media  align-items-center ">
                                       <div class="media-body text-left">
                                          <span class="font-weight-600 font-size-13 text-uppercase  text-secondary-2">Projects</span>
                                       </div>
                              ...
                              <li class="outer radius-2 mb-3">
                                 <a class=" inner radius-2" href="#blog" >
                                    <div class="media  align-items-center ">
                                       <div class="media-body text-left">
                                          <span class="font-weight-600 font-size-13 text-uppercase text-secondary-2">Certificates</span>
                                       </div>
                                       <svg version="1.1" class="max-width-1 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                              ...
                              <li class="outer radius-2 mb-3">
                                 <a class=" inner radius-2" href="#contact" >
                                    <div class="media  align-items-center ">
                                       <div class="media-body text-left">
                                          <span class="font-weight-600 font-size-13 text-uppercase  text-secondary-2">Contact</span>
                                       </div>
                                       <svg version="1.1" class="max-width-1 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
